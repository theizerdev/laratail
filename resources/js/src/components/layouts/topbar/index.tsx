      ...
      <div className="w-full flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="topbar-item hs-dropdown relative inline-flex">
            <button className="hs-dropdown-toggle cursor-pointer bg-primary/20 text-primary font-bold rounded-full size-9.5 flex items-center justify-center">
              {initials}
            </button>
              ...
              <div className="p-2">
                ...
                <Link to="#!" className="flex gap-3">
                  <div className="relative inline-block">
                    <div className="size-12 rounded bg-primary/20 text-primary font-bold flex items-center justify-center text-lg">
                      {initials}
                    </div>
                    <span className="-top-1 -end-1 absolute w-2.5 h-2.5 bg-green-400 border-2 border-white rounded-full"></span>
                  </div>
                  <div className="overflow-hidden">
                    <h6 className="mb-1 text-sm font-semibold text-default-800 truncate">{user?.name || 'User'}</h6>
