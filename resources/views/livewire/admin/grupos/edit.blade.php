<div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Editar Grupo: {{ $group->name }}</h2>
            <p class="mt-1 text-sm text-gray-500">Modifica los datos del grupo y sus roles.</p>
        </div>
        ...
        <form wire:submit="save">
            <div class="space-y-6">
                ...
                <div class="rounded-lg border border-violet-100 bg-violet-50 p-4">
                    <h3 class="text-sm font-semibold text-violet-900">Roles actuales: {{ count($selectedRoles) }}</h3>
                    <p class="mt-1 text-xs text-violet-700">
                        Este grupo tiene {{ count($selectedRoles) }} rol(es) asignado(s) por defecto.
                    </p>
                </div>
