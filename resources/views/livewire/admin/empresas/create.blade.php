<div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Crear Nueva Empresa</h2>
            <p class="mt-1 text-sm text-gray-500">Completa los campos para registrar una nueva empresa.</p>
        </div>
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl bg-white p-6 shadow-sm">
            ...
            <p class="text-xs text-gray-500 mb-4">Haz clic en el mapa para establecer la ubicacion de la empresa. Se obtendra la direccion automaticamente.</p>
