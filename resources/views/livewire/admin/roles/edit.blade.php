<div>
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Editar Rol: {{ $role->name }}</h2>
            <p class="mt-1 text-sm text-gray-500">Modifica los datos del rol y sus permisos.</p>
        </div>
        ...
        <form wire:submit="save">
            <div class="space-y-6">
                ...
                <div class="rounded-lg border border-indigo-100 bg-indigo-50 p-4">
                    <h3 class="text-sm font-semibold text-indigo-900">Permisos actuales: {{ count($selectedPermissions) }}</h3>
                    <p class="mt-1 text-xs text-indigo-700">
                        Este rol tiene {{ count($selectedPermissions) }} permiso(s) asignado(s).
                        Los permisos marcados abajo reflejan la configuración actual.
                    </p>
                </div>
