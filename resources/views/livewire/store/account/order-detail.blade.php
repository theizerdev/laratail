                ...
                <div class="bg-white rounded-2xl border border-zinc-100 shadow-sm p-6 mb-6">
                    ...
                    <div class="divide-y divide-zinc-100">
                        ...
                        <div class="flex items-center gap-4 py-4">
                            <a href="{{ route('store.product.detail', optional($item->product)->slug ?? '#') }}" wire:navigate class="flex-shrink-0">
                                <img src="{{ optional($item->product)->imagen_principal_url ?? 'https://placehold.co/80' }}" class="w-16 h-20 rounded-lg object-cover bg-zinc-100" alt="">
                            </a>
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-zinc-500 mt-0.5">
                                    {{ $item->cantidad }} × {{ format_order_item_price($item) }}
                                </p>
                            </div>
                    ...
                    <div class="mt-4 pt-4 border-t border-zinc-100 space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span>{{ format_display_price($usdSubtotal, $vesSubtotal) }}</span>
                        </div>
                        @if($usdDescuento > 0)
                        ...
                        <div class="flex justify-between">
                            ...
                            <span>{{ format_display_price($usdEnvio, $vesEnvio) }}</span>
                        </div>
                        @endif
