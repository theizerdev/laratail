<x-layouts.auth>
    ...
    {{-- Heading --}}
    <div class="mb-8">
        <h1 class="text-2xl font-bold tracking-tight text-zinc-900">Iniciar Sesión (Tienda)</h1>
        <p class="mt-2 text-sm text-zinc-500">
            Inicia sesión en tu cuenta de la tienda para continuar.
        </p>
    </div>
